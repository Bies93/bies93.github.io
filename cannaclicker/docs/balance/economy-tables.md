...
ROI ist hier `baseCost / baseBps` in Sekunden ohne Multiplikatoren. Spaetere Items duerfen effizienter werden, weil Unlocks, Cost-Factors und Milestones den Einstieg kontrollieren.
...
- Early Items haben groessere strategische Relevanz durch Klick-, Seed- und Root-Network-Synergien.
...
| ---------------- | ------: | --------------------------------- | --------------------- | ------------------------------------------------- |
| precision_trim   |     170 | 125 total Buds                    | Minute 5-8            | BPC bleibt relevant.                              |
...
| ------------- | ---------------------------- | ------------------------------------------ | ---------------------------------------- |
| golden_bud    | Early Gate                   | 15s Produktion oder BPC-Fallback           | Sofort gut, aber kein Tier-Skip.         |
| seed_pack     | Early Gate                   | 1-5 Seeds, cap-respektierend               | Meta-Hook ohne Pflicht.                  |
| lucky_joint   | Early Gate                   | x2 BPS/BPC fuer 15s                        | Kurzes aktives Fenster.                  |
| fertile_rain  | Early Gate                   | 10s Produktion + x1.25 BPS fuer 12s        | Belohnung plus kleiner Buff.             |
| market_rush   | Early Gate                   | x1.6 BPS/BPC fuer 20s                      | Kauf- und Klickfenster.                  |
| green_surge   | Early Gate                   | x2.5 BPC fuer 10s                          | Aktives Klicken bleibt sichtbar.         |
| supply_drop   | Early Gate                   | 12s Produktion + Shopkosten x0.85 fuer 16s | Buy-Max-Moment.                          |
| flash_harvest | 2.5k total Buds              | 18s Produktion + schnelle Golden Buds      | Mid-Early Spike.                         |
| calm_growth   | 2.5k total Buds              | x1.85 BPS fuer 24s                         | Idle-Spieler bekommen ein gutes Fenster. |
| mutant_sprout | 50k total Buds oder Prestige | 24s Produktion + hohe Seed-Chance          | Seltene Meta-Belohnung.                  |
| overgrowth    | 250k total Buds              | 30s Produktion + x1.35 BPS fuer 20s        | Spaeterer Reward-Spike.                  |
| seed_bloom    | 50k total Buds oder Prestige | Seed + x1.5 BPC fuer 18s                   | Seeds und aktives Spiel verbinden.       |

## Seeds, Prestige, Offline

| System               | Wert                                                                 | Ziel                                                          |
| -------------------- | -------------------------------------------------------------------- | ------------------------------------------------------------- |
| Prestige Requirement | 1,000,000 Lifetime-Buds im Run                                       | Erstes Prestige nicht vor dem Kernloop.                       |
| Seed Gain            | `floor(sqrt(lifetimeBuds / 1,000,000))`, mindestens 1 ab Requirement | Zu fruehes Prestige gibt wenig, zu spaetes mehr.              |
...
| Seed Cap             | 25/h bis 10M Lifetime, 60/h bis 3B, danach 110/h                     | Events koennen Seeds geben, aber nicht unbegrenzt eskalieren. |
...
| `__cannaBalance.addBuds(100000)`                    | Buds fuer Schwellen pruefen.                           |
