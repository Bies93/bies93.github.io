...
Stand: Sprint 1/2 Reboot. Werte sind bewusst release-nah, aber fuer weitere Playthroughs offen.
...
- Erster Prestige-Reset: ab 1,000,000 Run-Buds moeglich.
...
| 6    | Bewaesserungssystem |      28,000 |       1.215 |       240 | 20,000 Gesamtbuds      |
...
- Mindestanforderung: 1,000,000 Run-Buds.
- Seed-Auszahlung: `floor(sqrt(runBuds / 1,000,000))`, mindestens 1 Seed wenn die Anforderung erreicht ist.
- Naechster Seed: `(aktueller Seed-Gain + 1)^2 * 1,000,000` Run-Buds.
...
| ------------- | ------: | -------------------------------------- |
| Golden Bud    |    1.00 | Sofort 15s BPS, Fallback auf Klickwert |
| Seed Pack     |    0.55 | Seed-Drop                              |
| Lucky Joint   |    0.75 | 2.0x BPS/BPC fuer 15s                  |
| Fertile Rain  |    0.75 | Sofort 10s BPS                         |
| Market Rush   |    0.55 | 1.6x BPS/BPC fuer 20s                  |
| Green Surge   |    0.45 | 2.5x BPS/BPC fuer 10s                  |
...
- Precision Trim: ab 125 Gesamtbuds, Kosten 170.
...
- Ob der erste Prestige-Reset eher bei 45-90 Minuten oder spaeter liegen soll, muss per Playthrough entschieden werden.
- Seed-Caps koennen nach Sprint 3 hoeher werden, wenn Prestige zu langsam wirkt.
