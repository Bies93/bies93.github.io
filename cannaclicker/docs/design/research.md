...
Research ist in sechs Cluster gegliedert:

| Cluster     | Rolle                                                           |
| ----------- | --------------------------------------------------------------- |
| Efficiency  | Globale Produktion und Item-Boni.                               |
| Active Play | BPC, Skill-Dauer und aktive Session-Spitzen.                    |
| Automation  | Auto-Klicks, Offline-Cap und passive Seeds.                     |
| Events      | Frequenz, Dauer und Wert von Zufallsevents.                     |
| Genetics    | Strain-Entscheidungen und Seed-Synergien.                       |
| Economy     | Kostenreduktion, Seed-Research-Rabatte und Restart-Stabilitaet. |
...
| Event-Fokus      | `r_event_scouts`, `r_event_signals`, `r_event_rewarding`     |
| Economy/Prestige | `r_econ_seed_grants`, `r_econ_restart_kit`, `r_eff_genetics` |
