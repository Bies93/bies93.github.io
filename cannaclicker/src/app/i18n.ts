...
const translations: Record<LocaleKey, Record<string, string>> = {
  de: {
    ...
    'prestige.modal.description': 'Soft reset clears buds, buildings and upgrades. Seeds stay with you.',
    ...
    'prestige.modal.globalBonus': 'Global bonus',
    'prestige.modal.requirement': 'Requires {value} lifetime buds',
    'prestige.modal.tooSoon': 'Not enough buds for more seeds',
    'prestige.modal.checkbox': 'I understand the soft reset',
    'prestige.modal.confirm': 'Prestige now',
    'prestige.badge.tooltip': 'Global bonus: +{value}%',
    'prestige.control.locked': 'Prestige unlocks at {requirement} lifetime buds',
