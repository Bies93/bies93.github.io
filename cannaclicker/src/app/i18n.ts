...
const translations: Record<LocaleKey, Record<string, string>> = {
  de: {
    ...
    'panel.prestige.description':
      'Prestige setzt Buds, Gebäude und Upgrades zurück. Der Reset zahlt Seeds aus; Seeds und Meilensteine bleiben aktiv.',
  ...
  en: {
    ...
    'panel.prestige.description':
      'Prestige resets buds, buildings, and upgrades. The reset awards seeds; seeds and milestones stay active.',
