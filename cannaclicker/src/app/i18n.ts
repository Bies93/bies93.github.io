...
const translations: Record<LocaleKey, Record<string, string>> = {
  de: {
    ...
    'panel.prestige.description':
      'Prestige setzt Buds, Gebäude und Upgrades zurück. Meilensteine bleiben aktiv und verleihen dauerhafte Boni sowie einen Kickstart.',
    ...
    'milestones.progress.unlocked': 'Freigeschaltet {unlocked}/{total} · Beste Stufe {current}/{target}',
    ...
    'prestige.kickstart.activeSummary': 'Aktiv (Stufe {level}): ×{mult} BPS/BPC für noch {remaining}{cost}',
    'prestige.badge.tooltip': 'Prestige bereit – Boni: {bonus}',
  ...
  en: {
    ...
    'prestige.kickstart.activeSummary': 'Active (Lv. {level}): ×{mult} BPS/BPC for {remaining}{cost}',
    'prestige.badge.tooltip': 'Prestige ready – bonuses: {bonus}',
