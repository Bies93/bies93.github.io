...
const translations: Record<LocaleKey, Record<string, string>> = {
  de: {
    ...
    'toggle.on': 'AN',
    'toggle.off': 'AUS',
    'events.goldenBud.label': 'Goldener Bud',
    'events.goldenBud.toastTitle': 'Goldener Bud',
    'events.goldenBud.toastBody': '+{buds} Buds sofort eingesackt!',
    'events.seedPack.label': 'Seed-Pack',
    'events.seedPack.toastTitle': 'Seed-Pack',
    'events.seedPack.toastBody': '+{seeds} Seeds erhalten!',
    'events.luckyJoint.label': 'Lucky Joint',
    'events.luckyJoint.toastTitle': 'Lucky Joint',
    'events.luckyJoint.toastBody': '{multiplier}× Produktion fuer {duration}s!',
  },
  en: {
    'app.title': 'CannaClicker',
    'stats.buds': 'Buds',
    ...
    'toggle.off': 'OFF',
    'events.goldenBud.label': 'Golden Bud',
    'events.goldenBud.toastTitle': 'Golden Bud',
    'events.goldenBud.toastBody': '+{buds} buds instantly!',
    'events.seedPack.label': 'Seed Pack',
    'events.seedPack.toastTitle': 'Seed Pack',
    'events.seedPack.toastBody': '+{seeds} seeds collected!',
    'events.luckyJoint.label': 'Lucky Joint',
    'events.luckyJoint.toastTitle': 'Lucky Joint',
    'events.luckyJoint.toastBody': '{multiplier}× production for {duration}s!',
  },
};
